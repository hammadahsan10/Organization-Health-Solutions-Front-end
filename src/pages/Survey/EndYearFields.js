...
const EndYearFields = () => {
    ...
    const formik = useFormik({
        ...
        initialValues: {
            ...
            header3: "End Year Review of Growth Goals",
            header4: "Review of Opportunities for Growth",
            header5: "Review of Holistic Life Goals",
            header6: "Your Achievements for the year",
        ...
        <>
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div>
                    <div className="scroll-container card flex justify-content-between mt-4">
                        <div className="flex flex-row" style={{ alignItems: "center" }}>
                            <h5 style={{ color: 'black' }} className="ml-6">Top 5 Holistic</h5>
                        </div>
                        <div className='flex justify-content-between' style={{ display: 'flex', alignItems: 'center' }}>
                            <div className="ml-4">
                                <Button
