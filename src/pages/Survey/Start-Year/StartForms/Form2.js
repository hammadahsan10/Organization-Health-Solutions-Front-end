                        ...
                        <div className='col-12 flex flex-row mt-4'>
                            ...
                            <div className="field col-12 md:col-6 pl-6 pr-6">
                                <span className='flex flex-row'>
                                    ...
                                    <span className='ml-3' style={{ marginTop: "-2px" }}> <Badge value='Me' style={{ backgroundColor: '#009bcb' }} /> </span>
                                </span>
                        ...
                        <div className='col-12 flex flex-row'>
                            ...
                            <div className="field col-12 md:col-6 pl-6 pr-6">
                                <span className='flex flex-row'>
                                    ...
                                    <span className='ml-3' style={{ marginTop: "-2px" }}> <Badge value='Manager' style={{ backgroundColor: '#009bcb' }} /> </span>
                                </span>
                        ...
                        <>
                            ...
                            <div style={{ border: '1px solid #ccc', padding: '10px', borderRadius: '8px', width: "100%" }} className='mt-4'>
                                ...
                                <div className='col-12 flex flex-row'>
                                    ...
                                    <div className="field col-12 md:col-6 pl-6 pr-6">
                                        <span className='flex flex-row'>
                                            <Rating disabled={role_Name == 'Manager' ? true : false} id='value24' name='value24' value={formik.values.value24} onChange={formik.handleChange} cancel={false} />
                                            <span className='ml-3' style={{ marginTop: "-2px" }}> <Badge value='Manager' style={{ backgroundColor: '#009bcb' }} /> </span>
                                        </span>
                            ...
                            <div style={{ border: '1px solid #ccc', padding: '10px', borderRadius: '8px', width: "100%" }} className='mt-4'>
                                ...
                                <div className='col-12 flex flex-row'>
                                    ...
                                    <div className="field col-12 md:col-6 pl-6 pr-6">
                                        <span className='flex flex-row'>
                                            <Rating disabled={role_Name == 'Manager' ? true : false} id='value26' name='value26' value={formik.values.value26} onChange={formik.handleChange} cancel={false} />
                                            <span className='ml-3' style={{ marginTop: "-2px" }}> <Badge value='Manager' style={{ backgroundColor: '#009bcb' }} /> </span>
                                        </span>
