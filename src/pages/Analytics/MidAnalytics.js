...
import ViewStrengths from './View-Screens-Mid/ViewStrengths';
import { Dialog } from 'primereact/dialog';
import ViewGoals from './View-Screens-Mid/ViewGoals';
import ViewOppoGoals from './View-Screens-Mid/ViewOppoGoals';
import { ProgressBar } from 'primereact/progressbar';
import ViewHolisticGoals from './View-Screens-Mid/ViewHolisticGoals';

const MidAnaylytics = ({ userId2, userId3 }) => {
    ...
    const getSurveyListByUserId = async () => {
        ...
        if (response.length) {
            const result = response && response.filter(item => item.Name == 'Mid of the Year Survey')
            setMyData(result[0]);
        }
        else {
            setMyData(response)
                    ...
                    <div className='mr-1 col-7 card'>
                        ...
                        <div className='scroll-container2 mt-6 col-12 flex flex-row' style={{ marginLeft: "-14px" }}>
                            <div className='col-4 flex flex-column' style={{ border: "2px solid rgb(210 210 210)", borderRadius: "20px", padding: "20px" }}>
                                <div className='flex flex-row justify-content-between'>
                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="light-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value44 / 5) * 100)} text={myData?.value44 ? `${Math.floor((myData?.value44 / 5) * 100)}%` : 'N/A'} />
                                    </div>

                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="dark-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value45 / 5) * 100)} text={myData?.value45 ? `${Math.floor((myData?.value45 / 5) * 100)}%` : 'N/A'} />
                                    </div>
                                </div>
                                <div className='flex-column mt-3 text-center' style={{ marginBottom: "-18px" }}>
                                    <h5 style={{ color: 'black' }}>
                                        {myData?.dupvalue44 && myData.dupvalue44.length > 20 ? `${myData.dupvalue44.substring(0, 20)}...` : myData?.dupvalue44}
                                    </h5>
                                </div>
                            </div>
                            ...
                            <div className='ml-3 col-4 flex flex-column' style={{ border: "2px solid rgb(210 210 210)", borderRadius: "20px", padding: "20px" }}>
                                <div className='flex flex-row justify-content-between'>
                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="light-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value46 / 5) * 100)} text={myData?.value46 ? `${Math.floor((myData?.value46 / 5) * 100)}%` : 'N/A'} />
                                    </div>

                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="dark-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value47 / 5) * 100)} text={myData?.value47 ? `${Math.floor((myData?.value47 / 5) * 100)}%` : 'N/A'} />
                                    </div>
                                </div>
                                <div className='flex-column mt-3 text-center' style={{ marginBottom: "-18px" }}>
                                    <h5 style={{ color: 'black' }}>
                                        {myData?.dupvalue46 && myData.dupvalue46.length > 20 ? `${myData.dupvalue46.substring(0, 20)}...` : myData?.dupvalue46}
                                    </h5>
                                </div>
                            </div>
                            ...
                            <div className='ml-3 col-4 flex flex-column' style={{ border: "2px solid rgb(210 210 210)", borderRadius: "20px", padding: "20px" }}>
                                <div className='flex flex-row justify-content-between'>
                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="light-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value48 / 5) * 100)} text={myData?.value48 ? `${Math.floor((myData?.value48 / 5) * 100)}%` : 'N/A'} />
                                    </div>

                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="dark-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value49 / 5) * 100)} text={myData?.value49 ? `${Math.floor((myData?.value49 / 5) * 100)}%` : 'N/A'} />
                                    </div>
                                </div>
                                <div className='flex-column mt-3 text-center' style={{ marginBottom: "-18px" }}>
                                    <h5 style={{ color: 'black' }}>
                                        {myData?.dupvalue48 && myData.dupvalue48.length > 20 ? `${myData.dupvalue48.substring(0, 20)}...` : myData?.dupvalue48}
                                    </h5>
                                </div>
                            </div>
                            ...
                            <div className='ml-3 col-4 flex flex-column' style={{ border: "2px solid rgb(210 210 210)", borderRadius: "20px", padding: "20px" }}>
                                <div className='flex flex-row justify-content-between'>
                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="light-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value50 / 5) * 100)} text={myData?.value50 ? `${Math.floor((myData?.value50 / 5) * 100)}%` : 'N/A'} />
                                    </div>

                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="dark-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value51 / 5) * 100)} text={myData?.value51 ? `${Math.floor((myData?.value51 / 5) * 100)}%` : 'N/A'} />
                                    </div>
                                </div>
                                <div className='flex-column mt-3 text-center' style={{ marginBottom: "-18px" }}>
                                    <h5 style={{ color: 'black' }}>
                                        {myData?.dupvalue50 && myData.dupvalue50.length > 20 ? `${myData.dupvalue50.substring(0, 20)}...` : myData?.dupvalue50}
                                    </h5>
                                </div>
                            </div>
                            ...
                            <div className='ml-3 col-4 flex flex-column' style={{ border: "2px solid rgb(210 210 210)", borderRadius: "20px", padding: "20px" }}>
                                <div className='flex flex-row justify-content-between'>
                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="light-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value52 / 5) * 100)} text={myData?.value52 ? `${Math.floor((myData?.value52 / 5) * 100)}%` : 'N/A'} />
                                    </div>

                                    <div style={{ width: '80px', height: '80px' }}>
                                        <CircularProgressbar className="dark-blue-progress-bar" strokeWidth={12} value={Math.floor((myData?.value53 / 5) * 100)} text={myData?.value53 ? `${Math.floor((myData?.value53 / 5) * 100)}%` : 'N/A'} />
                                    </div>
                                </div>
                                <div className='flex-column mt-3 text-center' style={{ marginBottom: "-18px" }}>
                                    <h5 style={{ color: 'black' }}>
                                        {myData?.dupvalue52 && myData.dupvalue52.length > 20 ? `${myData.dupvalue52.substring(0, 20)}...` : myData?.dupvalue52}
                                    </h5>
                                </div>
                            </div>
                        </div>
